...
div.innerHTML="<h2 id='header"+id_div+"'></h2><label for='price"+id_div+"'>Price</label><input type='text' disabled id='price"+id_div+"'><br><label for='amountOf"+id_div+"'>Amount of people</label><input type='text' disabled id='amountOf"+id_div+"'>";
